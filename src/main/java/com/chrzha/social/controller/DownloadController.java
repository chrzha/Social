...
public class DownloadController {
	...
	@ResponseBody
	public String download(@RequestParam("fileName") String fileName) throws FileNotFoundException {
		...
		sheet.setColumnWidth((short)0, (short)150);
		sheet.setColumnWidth((short)1, (short)150);
